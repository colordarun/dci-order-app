...
const PRODUCTS = {
  pigments: [
    ...
    { code: 'PIC-BRD',   name: '브릭레드 / Brick Red',                        spec: '10g, 액상',        priceL: 7000,   priceS: 7700,   priceDefault: 8400, color: '#bd4c42', shape: 'circle' },
...
const COURSE_PRODUCTS = {
  CCM1: [
        'PIG-Z.BR', 'PIG-X.RD', 'PIC-BRD', 'PIG-Z.RD', 'PIG-YL', 'PIG-WT',
  ...
  SFDI: [
    'PIG-Z.BR', 'PWD-Z.BR', 'PIG-X.RD', 'PIC-BRD', 'PIG-YL', 'PIG-WT', 'PIG-WT.2',
    'PIG-BL', 'PIG-BK',
