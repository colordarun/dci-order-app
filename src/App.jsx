...
const PRODUCTS = {
  pigments: [
    { code: 'PIG-Z.BR',  name: 'Z-브라운 색소 / Z-Brown',                 spec: '10g',              priceL: 7000,   priceS: 7700,   priceDefault: 8400,  color: '#9e5c3f', shape: 'circle' },
    { code: 'PWD-Z.BR',  name: 'Z-브라운 색소 파우더 / Z-Brown Powder',     spec: '10g, 분말',        priceL: 9000,   priceS: 9900,   priceDefault: 10800, color: '#9e5c3f', shape: 'square' },
    { code: 'PWD-ZL.BR',  name: 'Z-미들브라운 색소 파우더 / Z-Brown(L) Powder',     spec: '10g, 분말',        priceL: 9000,   priceS: 9900,   priceDefault: 10800, color: '#be8f7a', shape: 'square' },    
    { code: 'PIG-X.RD',  name: 'X-레드브릭 색소 / X-Red(Brick)',                   spec: '10g',              priceL: 5000,   priceS: 5500,   priceDefault: 6000,  color: '#a11515', shape: 'circle' },
    { code: 'PIG-YL',    name: '옐로우 색소 / Yellow',                        spec: '10g',              priceL: 5000,     priceS: 5500, priceDefault: 6000, color: '#D4A800', shape: 'circle' },
    { code: 'PIG-Z.RD',  name: 'Z-레드 색소 / Z-Red(vivid)',               spec: '10g, ONLY for Lips',    priceL: 9000,     priceS: 9900, priceDefault: 10800, color: '#f50707', shape: 'circle' },
  ...
  binders: [
    ...
    { code: 'BND-LIP1',   name: '립글로스 바인더 / Lip Gloss Binder',                 spec: '50ml',            priceL: 12000,   priceS: 15000,   priceDefault: 19000 },
    { code: 'BND-LIP5',   name: '립글로스 바인더 대용량 / Lip Gloss Binder (250ml)',   spec: '250ml, 5개 묶음', priceL: 50000,  priceS: 68000,  priceDefault: 88000 },
  ],
  cards: [
  ...
  bottles: [
    ...
    { code: 'BTL-LGS',   name: '립글로스 용기 / Lip Gloss Container',                                spec: '5ml_약6g',           priceL: 1200, priceS: 1600, priceDefault: 2000 },
