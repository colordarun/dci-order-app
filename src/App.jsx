...
const PRODUCTS = {
  pigments: [
    ...
    { code: 'PIG-Z.RD',  name: 'Z레드(재은레드) / Z-Red',                    spec: '10g, for Lips',    priceL: 9000,   priceS: 9900,   priceDefault: 10800, color: '#B82020', shape: 'circle' },
    { code: 'PIG-X.RD',  name: 'X레드 / X-Red',                              spec: '10g',              priceL: 5000,   priceS: 5500,   priceDefault: 6000,  color: '#8a3221', shape: 'circle' },
