...
const PRODUCTS = {
  pigments: [
    ...
    { code: 'PIG-YL',    name: '노랑 색소 / Yellow',                        spec: '10g',              priceL: 5000,     priceS: 5500, priceDefault: 6000, color: '#D4A800', shape: 'circle' },
    { code: 'PIG-Z.RD',  name: 'YZ 레드 색소 / Z-Red(vivid)',               spec: '10g, for Lips',    priceL: 9000,     priceS: 9900, priceDefault: 10800, color: '#f50707', shape: 'circle' },
    { code: 'PIG-OR',    name: '주황 색소 / Orange',                        spec: '10g, for Lips',    priceL: 5000,    priceS: 5500, priceDefault: 6000, color: '#ff6f00', shape: 'circle' },
